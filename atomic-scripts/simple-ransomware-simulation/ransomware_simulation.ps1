...
# exe of ransomware payload - for example download the wildfire sample file, and put it in C:\Temp
$exePath = "C:\Temp\ransomware.exe"
...
foreach ($ransomeNoteLocation in $ransomNoteLocations) {
    ...
    Write-Host "  Ransom note created: $ransomeNoteLocation" -ForegroundColor Red
}
